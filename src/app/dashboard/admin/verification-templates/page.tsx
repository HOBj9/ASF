...
const VerificationTemplatesManagement = dynamic(
  () => import("@/components/admin/verification-templates-management").then(mod => ({ default: mod.VerificationTemplatesManagement })),
  {
    loading: () => <Loading />,
    ssr: false,
  }
  ...
  return (
    <div className="text-right">
      <div className="mb-6 lg:mb-8">
        <h1 className="text-2xl lg:text-3xl font-bold">إدارة قوالب التحقق</h1>
        <p className="text-muted-foreground mt-2">إدارة قوالب رسائل التحقق (يدعم placeholders: {`{code}`}, {`{brandName}`}, {`{greeting}`})</p>
      </div>
